...
class Embed(commands.Cog):
    ...
    colour: str = nextcord.SlashOption(name='colour', description='Proporcione un código hexadecimal para el color de su embed', choices={'Red':'EC2424', 'Blue':'1FD3F3', 'Green':'23E23D', 'Yellow':'EEEE14'}, required=False),
