...
class Embed(commands.Cog):
    ...
    colour: str = nextcord.SlashOption(name='colour', description='Proporcione un código hexadecimal para el color de su embed', choices={'Red':'Red', 'Blue':'0x1FD3F3', 'Green':'0x23E23D', 'Yellow':'0xEEEE14'}, required=False),
