...
class ServerInfo(commands.Cog):
    ...
    async def server_info(self, interaction: Interaction):
        ...
        embed.add_field(name='Contador de Miembros', value='{} humanos | {} bots | {} total'.format(interaction.guild.humans.count, interaction.guild.bots.count, interaction.guild.member_count), inline=False)
