...
class ServerInfo(commands.Cog):
    ...
    async def server_info(self, interaction: Interaction):
        ...
        embed.add_field(name='Contador de Miembros', value='{} humanos | {} bots | {} total'.format(len([interaction.guild.humans.count]), Contador_bots, interaction.guild.member_count), inline=False)
